...
programas.txt puede ser modificado para descargar cualquier dirección de release de un proyecto de java, siempre que sea .jar(actualmente el programa no soporta correctamente cuando existen múltiples .jar dentro de un .zip)
...
esto significa que su versión de java esta desactualizada, actualícela 
